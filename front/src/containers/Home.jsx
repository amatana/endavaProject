    ...
    !!props.user && !!props.user.isAdmin
      ? <div>
        ...
        <div className='homeDisplay'>
          ...
          {props.user.area !== 'RRHH' && <Link to="/tags" style={{ textDecorationLine: 'none' }}><div className='homeDIV'><button className="btn-lg botonHome">Tag Management</button></div></Link>}
        </div>
      </div>
